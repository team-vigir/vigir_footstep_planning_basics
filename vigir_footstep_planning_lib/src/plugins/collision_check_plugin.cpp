...
{
CollisionCheckPlugin::CollisionCheckPlugin(const std::string& name, const std::string& type, const vigir_generic_params::ParameterSet& params)
  : vigir_pluginlib::Plugin(name, type, params)
  , collision_check_flag(0)
{
}

CollisionCheckPlugin::CollisionCheckPlugin(const std::string& name, const std::string& type)
